/*
* Title: Programming Assignment 3 - Customer Loan Accounts
* Author: James Taddei
* Date: 2023-09-17
* Dscription:
*   This program creates and outputs 2 users and all of their loans.
*/
...
public class ProgrammingAssignment3 {
    ...
    public static void main(String[] args) {
        // Creates and outputs the relvenat loans for 2 users.
        ...
        Address propertyAddress1 = new Address("321 Main Street",
                "State College", "PA", "16801");
        PrimaryMortgage propertyLoan1 = new PrimaryMortgage(250000.00, 3.75,
                360, 35.12, propertyAddress1);
